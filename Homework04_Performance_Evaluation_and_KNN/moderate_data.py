...
# Read Moderate Data
moderateData_y = np.loadtxt("/home/franciscoAML/Documents/Homework4/Datasets/moderateData.csv", delimiter=",", usecols=0)
moderateData_scores = np.loadtxt("/home/franciscoAML/Documents/Homework4/Datasets/moderateData.csv", delimiter=",", usecols=1)
...
plt.plot(method_5_FPR, method_5_TPR, color="yellow", label="Method 5")
plt.legend()
plt.xlim([0.0,1.05])
plt.ylim([0.0,1.05])
plt.ylabel("$P_D$")
plt.xlabel("$P_{FA}$")
plt.title("moderateData")
plt.savefig("moderateData/Plot1")
