...
# Read Moderate Data
moderateData_y = np.loadtxt("/home/franciscoAML/Documents/Homework4/Datasets/bigData.csv", delimiter=",", usecols=0)
moderateData_scores = np.loadtxt("/home/franciscoAML/Documents/Homework4/Datasets/bigData.csv", delimiter=",", usecols=1)
...
plt.xlabel("$P_{FA}$")
plt.title("bigData")
plt.savefig("bigData/Plot1", dpi=1680, precision=95)
