...
# Read Moderate Data
moderateData_y = np.loadtxt("Datasets/logNormalData.csv", delimiter=",", usecols=0)
moderateData_scores = np.loadtxt("Datasets/logNormalData.csv", delimiter=",", usecols=1)
...
plt.xlabel("$P_{FA}$")
plt.title("logNormal")
plt.savefig("logNormal/Plot1", dpi=1680, precision=95)
